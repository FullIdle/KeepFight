...
public class V20 extends KFPlugin {
    ...
    public boolean playerInBattle(Player player) {
        ServerPlayer sp = PixelmonCommandUtils.getEntityPlayer(player.getUniqueId());
        BattleController battle = BattleRegistry.getBattle(sp);
        if (battle == null) return false;
        return !battle.hasSpectator(sp);
    }
